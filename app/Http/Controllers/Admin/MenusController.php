...
class MenusController extends AdminController
{
    ...
    public function create()
    {
    	...
    	$list = array();
    	$list = array_add($list,'0','Not using');
    	$list = array_add($list,'parent','The part of blog');
    ...
    public function edit(\Corp\Menu $menu)
    {
        ...
        $this->title = 'Link editing - '.$menu->title;
       ...
       // dump($parameters);
    	...
    	$list = array_add($list,'parent','Part of blog');
